...
const PerfilProsionalInfo = () => {
  ...
  return (
    <div className="barraPerfil">
      ...
      <h2 className="nombreProfesional" style={{fontWeight:'100', fontSize:'20px'}}>{profesional?.nombre || 'No'} {profesional?.apellido || 'encontrado'} </h2>
      <p className="rolProfesional">{profesional.especialidades || 'Rol no encontrado'}</p>

      <div className="reviewsProfesional" style={{paddingTop:'10px'}}>
        <p style={{textAlign:'left', fontWeight:'600'}}>Reviews</p>
        <span style={{ display: 'flex', justifyContent: 'flex-start', fontSize:'14px'}}>
          <span style={{color:'black', paddingRight:'80px', fontSize:'16px', color:'gray', fontWeight:'lighter'}}>
            Calificación
          </span>
          ⭐⭐⭐⭐⭐
        </span>
